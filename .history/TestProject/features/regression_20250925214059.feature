Feature: Application Regression Test
    ...
    Scenario: Update existing owner
        Given I open the home page
        When I click the Find Owners link
        And I enter last name "Farouk" in the search field
        And I click the Find Owner button
        And I click the owner link "Omar Farouk" with address "000 Pine Rd."
        And I click the Edit Owner button
        And I update owner details from JSON
        And I submit the Update Owner form
        Then I should see the updated owner "Layla Hassan" with address "123 Oak St.", city "Giza", and telephone "5559876543"
    ...
    Then I should see the new pet "Buddy" with birth date "2023-11-01" and type "dog" for owner "Islam Ibrahim"
    ...
    Scenario: Add a visit to a pet
        ...
        And I click the Find Owner button
        And I click the owner link "Islam Ibrahim" with address "000 Pine Rd."
    And I click the pet name link "Buddy"
