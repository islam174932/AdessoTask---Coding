...
When(
  ...
  async function (this: CustomWorld) {
    ...
    // Click the actual "Add Owner" button
...
When("I click the Find Owners link", async function (this: CustomWorld) {
  // The actual element is <span>Find Owners</span>, not a link with "Find owners"
...
Then(
  ...
  async function (
    ...
    // Wait for either table or owner info page
    await this.page.waitForSelector(
      'table#owners tbody tr, h2:has-text("Owner Information")',
      { timeout: 10000 }
    );
    ...
    if (isOwnerPage) {
      // Direct owner page - verify owner details
