...
// FIXED: Replace the problematic AddOwnerPage methods with direct selectors
When(
  "I enter owner details from JSON",
  { timeout: 60000 },
  async function (this: CustomWorld) {
    console.log("Starting to enter owner details...");
    ...
    // Use direct selectors instead of AddOwnerPage methods
    console.log("Filling first name...");
    await this.page!.locator('input[name="firstName"], #firstName').waitFor({
      state: "visible",
      timeout: 30000,
    });
    await this.page!.locator('input[name="firstName"], #firstName').fill(
      owner.firstName
    );
    ...
    await this.page!.locator('input[name="address"], #address').fill(
      owner.address
    );
    ...
    console.log("Filling telephone...");
    await this.page!.locator('input[name="telephone"], #telephone').fill(
      owner.telephone
    );

    console.log("Owner details entered successfully!");
...
When("I submit the Add Owner form", async function (this: CustomWorld) {
  // Use direct selector instead of AddOwnerPage method
