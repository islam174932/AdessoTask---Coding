...
When(
  ...
  async function (this: CustomWorld) {
    ...
    await this.page.waitForSelector('#address', { timeout: 10000 });
    await this.page.waitForSelector('#city', { timeout: 10000 });
    await this.page.waitForSelector('#telephone', { timeout: 10000 });
...
When("I click the Find Owner button", async function (this: CustomWorld) {
  const findOwnerBtn = this.page.locator('button.btn.btn-primary[type="submit"]');
