...
// Removed all comments from the file
...
When(
  ...
  async function (this: CustomWorld) {
    try {
      ...
      await this.page!.screenshot({
        path: "screenshots/pet-link-error.png",
        fullPage: true,
      });
      throw error;
    }
...
Then(
  ...
  async function (this: CustomWorld, message: string) {
    ...
    switch (message) {
      case "New Owner Created":
        await alertPage.validateNewOwnerCreated();
        break;
      case "Owner Values Updated":
        await alertPage.validateOwnerUpdated();
        break;
      case "New Pet has been Added":
        await alertPage.validateNewPetAdded();
        break;
      case "Your visit has been booked":
        await alertPage.validateVisitBooked();
        break;
      default:
        throw new Error(`Unknown success message: ${message}`);
    }
  }
);
