When(
  "I click the first owner link for {string} in the owners table",
  async function (this: CustomWorld, ownerName: string) {
...
Then(
  "the owner link for {string} with id {string} should be visible in the owners table",
  async function (this: CustomWorld, ownerName: string, ownerId: string) {
