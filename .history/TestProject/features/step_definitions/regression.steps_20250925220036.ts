...
When("I enter owner details from JSON", async function (this: CustomWorld) {
  ...
  await this.page!.waitForSelector('form#add-owner-form, form[action*="owners/new"]', { state: "visible", timeout: 15000 });
  await this.addOwnerPage!.firstNameInput().waitFor({ state: "visible", timeout: 15000 });
