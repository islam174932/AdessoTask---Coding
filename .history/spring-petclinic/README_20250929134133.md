...
Before running the tests, please start the website locally. On Windows, use the following commands to run the application on port 8081:
...
This will start the Petclinic application at <http://localhost:8081/> so the tests can run successfully.
