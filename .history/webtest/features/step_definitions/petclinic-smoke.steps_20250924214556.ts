...
Then(
  "I should see the Home navigation link",
  async function (this: CustomWorld) {
    expect(
      await this.page!.isVisible(this.homePage!.homeNavSelector)
    ).toBeTruthy();
  }
);
...
Then(
  "I should see the Find Owners navigation link",
  async function (this: CustomWorld) {
    expect(
      await this.page!.isVisible(this.homePage!.findOwnersNavSelector)
    ).toBeTruthy();
  }
);

When(
  "I click the Find Owners navigation link",
  async function (this: CustomWorld) {
...
Then(
  "I should see the Veterinarians navigation link",
  async function (this: CustomWorld) {
    expect(
      await this.page!.isVisible(this.homePage!.veterinariansNavSelector)
    ).toBeTruthy();
  }
);

When(
  "I click the Veterinarians navigation link",
  async function (this: CustomWorld) {
...
Then(
  "I should be on the Veterinarians page",
  async function (this: CustomWorld) {
...
Then(
  "I should see the Error navigation link",
  async function (this: CustomWorld) {
    expect(
      await this.page!.isVisible(this.homePage!.errorNavSelector)
    ).toBeTruthy();
  }
);
